...
var initProgram = setTimeout(function () {
  var greeting = "Portfolio.Isf-Sofiane";
  var message = "[error > retour]";
  var $identityDiv = $("#identity-results");
  var $name = "Prenom: Sofiane";
  var $alias = "ALIAS: ISF";
  var $occupation = "[???]: Vidéaste | Photographe";
  var $frontEnd = ">___________________________________________________";
...
//   var $cmsDevelopment = "WORDPRESS DEVELOPMENT: WORDPRESS";
  var $wordpress = "Langue : Anglais | B1";
